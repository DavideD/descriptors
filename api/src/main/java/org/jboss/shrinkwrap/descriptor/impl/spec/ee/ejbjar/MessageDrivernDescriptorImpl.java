 ...
 *
 */
public class MessageDrivernDescriptorImpl extends EnterpriseBeansDescriptorImpl implements MessageDrivenDescriptor
{
   private final MessageDrivenBeanType messageDrivenBean;

   public MessageDrivernDescriptorImpl(EjbJarModel model)
   {
      super(model);
      MessageDrivenBeanType messageDrivenBean = new MessageDrivenBeanType();
      model.getEnterpriseBeans().getSessionOrEntityOrMessageDriven().add(messageDrivenBean);
