...
public class HandlerType {
    ...
    protected org.jboss.shrinkwrap.descriptor.impl.spec.ee.ejbjar.javaee.String handlerName;
    ...
    protected List<org.jboss.shrinkwrap.descriptor.impl.spec.ee.ejbjar.javaee.String> soapRole;
    @XmlElement(name = "port-name")
    protected List<org.jboss.shrinkwrap.descriptor.impl.spec.ee.ejbjar.javaee.String> portName;
     ...
     *     
     */
    public org.jboss.shrinkwrap.descriptor.impl.spec.ee.ejbjar.javaee.String getHandlerName() {
        return handlerName;
    }
     ...
     *     
     */
    public void setHandlerName(org.jboss.shrinkwrap.descriptor.impl.spec.ee.ejbjar.javaee.String value) {
     ...
     * 
     */
    public List<org.jboss.shrinkwrap.descriptor.impl.spec.ee.ejbjar.javaee.String> getSoapRole() {
        if (soapRole == null) {
            soapRole = new ArrayList<org.jboss.shrinkwrap.descriptor.impl.spec.ee.ejbjar.javaee.String>();
        }
     ...
     * 
     */
    public List<org.jboss.shrinkwrap.descriptor.impl.spec.ee.ejbjar.javaee.String> getPortName() {
        if (portName == null) {
            portName = new ArrayList<org.jboss.shrinkwrap.descriptor.impl.spec.ee.ejbjar.javaee.String>();
        }
